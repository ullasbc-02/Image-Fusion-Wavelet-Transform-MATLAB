...
fusion = idwt2(LL,LH,HL,HH,'haar');
%%
subplot(133);imshow(uint8(fusion));title('fusion  : dwt');

%filename = "Testimage_gray.PNG" or "Testimage_gray.jpg"
%filename = "Testimage_color.PNG" or "Testimage_color.jpg"
im = imread('C:\Users\Admin\Downloads\parrot.png');
rgbImage = ind2rgb(im, gray(256));
imshow(rgbImage);
...
fprintf('Structural  Similarity  based  Metric for dwt fusion :%f\n',Qs);
